...
{
	return convert_to<std::string>(m_strCharset.c_str(), strWideChar,
	       rawsize(strWideChar), CHARSET_WCHAR);
}
...
{
	return convert_to<std::string>(m_strCharset.c_str(), lpwWideChar,
	       rawsize(lpwWideChar), CHARSET_WCHAR);
}
